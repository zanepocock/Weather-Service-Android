 ...
 * to an Activity. "Originator" to the Memento pattern.
 */
public class RetainedFragmentManager {
	...
	/**
	 * Initialises the RetainedFragment the first time it's called.
	 *
	...
	public boolean firstTimeIn() {
		try {
			...
			// RetainedFragment has no UI so it must be referenced via a tag.
	...
	/**
	 * Return the Activity the RetainedFragment is attached to
	 * or null if it's not currently attached.
	 */
	 ...
	 * configuration changes. "Memento" of the Memento pattern.
	 */
