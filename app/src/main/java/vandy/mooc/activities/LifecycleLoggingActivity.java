 ...
 * lifecycle callbacks for logging certain lifecycle events.
 */
public abstract class LifecycleLoggingActivity extends Activity {
     ...
     * One-time initialisation code should go here, e.g. UI layout,
     * some class scope variable initialisation. If finish() is
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        if(savedInstanceState != null) {
            ...
            // savedInstanceState bundle for initialisations either
    ...
    /**
     * Hook method called after either onCreate() or onRestart() (when
     ...
     * there is a prior saved instance state in the Bundle object.
     ...
     * start animations and acquire exclusive resources, such as the
     * camera.
     */
    @Override
    protected void onResume(){
        // Always call super class for necessary
        // initialisation/implementation and then log which lifecycle
     ...
     * called, e.g. when system kills hosting process.
     */
    @Override
